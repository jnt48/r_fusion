...
const SignupForm = () => {
    ...
    <section>
      <div
        ...
        style={{ backgroundColor: 'hsl(0, 0%, 96%)' ,marginTop:"90px" }}
      >
        <div className="container">
          <div className="row gx-lg-5 align-items-center">
            ...
            <div className="col-lg-6 mb-5 mb-lg-0">
              <div className="card">
                <h3 style={{marginLeft:"210px", marginTop:"30px",fontWeight:"700"}}>Welcome Back</h3>
                <div className="card-body py-5 px-md-5">
                  <form>
                    ...
                    <div className="text-center">
                      ...
                      <p>Didn't have an account? <a style={{color:"#22A7F0",fontWeight:"800"}} onClick={e=>router.push(`/login`)}>Create Account</a></p>
